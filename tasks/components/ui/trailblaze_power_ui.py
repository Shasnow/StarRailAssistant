...
class Ui_TrailblazePowerWidget(object):
    def setupUi(self, TrailblazePowerWidget):
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, -220, 313, 960))
    ...
    def retranslateUi(self, TrailblazePowerWidget):
        ...
        self.stagnantShadow_comboBox.setItemText(8, QCoreApplication.translate("TrailblazePowerWidget", u"\u6d77\u5996\u6b8b\u9ccd\uff08\u51b0\uff09", None))
        self.stagnantShadow_comboBox.setItemText(9, QCoreApplication.translate("TrailblazePowerWidget", u"\u51b7\u85cf\u68a6\u7bb1\uff08\u51b0\uff09", None))
        self.stagnantShadow_comboBox.setItemText(10, QCoreApplication.translate("TrailblazePowerWidget", u"\u82e6\u5bd2\u6676\u58f3\uff08\u51b0\uff09", None))
        self.stagnantShadow_comboBox.setItemText(11, QCoreApplication.translate("TrailblazePowerWidget", u"\u98ce\u96ea\u4e4b\u89d2\uff08\u51b0\uff09", None))
        self.stagnantShadow_comboBox.setItemText(12, QCoreApplication.translate("TrailblazePowerWidget", u"\u517d\u9986\u4e4b\u9489\uff08\u96f7\uff09", None))
        self.stagnantShadow_comboBox.setItemText(13, QCoreApplication.translate("TrailblazePowerWidget", u"\u70bc\u5f62\u8005\u96f7\u679d\uff08\u96f7\uff09", None))
        self.stagnantShadow_comboBox.setItemText(14, QCoreApplication.translate("TrailblazePowerWidget", u"\u5f80\u65e5\u4e4b\u5f71\u7684\u96f7\u51a0\uff08\u96f7\uff09", None))
        self.stagnantShadow_comboBox.setItemText(15, QCoreApplication.translate("TrailblazePowerWidget", u"\u66ae\u8f89\u70ec\u857e\uff08\u98ce\uff09", None))
        self.stagnantShadow_comboBox.setItemText(16, QCoreApplication.translate("TrailblazePowerWidget", u"\u4e00\u676f\u9169\u914a\u7684\u65f6\u4ee3\uff08\u98ce\uff09", None))
        self.stagnantShadow_comboBox.setItemText(17, QCoreApplication.translate("TrailblazePowerWidget", u"\u65e0\u4eba\u9057\u57a2\uff08\u98ce\uff09", None))
        self.stagnantShadow_comboBox.setItemText(18, QCoreApplication.translate("TrailblazePowerWidget", u"\u66b4\u98ce\u4e4b\u773c\uff08\u98ce\uff09", None))
        self.stagnantShadow_comboBox.setItemText(19, QCoreApplication.translate("TrailblazePowerWidget", u"\u6697\u5e37\u6708\u534e\uff08\u91cf\u5b50\uff09", None))
        self.stagnantShadow_comboBox.setItemText(20, QCoreApplication.translate("TrailblazePowerWidget", u"\u7099\u68a6\u55b7\u67aa\uff08\u91cf\u5b50\uff09", None))
        self.stagnantShadow_comboBox.setItemText(21, QCoreApplication.translate("TrailblazePowerWidget", u"\u82cd\u733f\u4e4b\u9489\uff08\u91cf\u5b50\uff09", None))
        self.stagnantShadow_comboBox.setItemText(22, QCoreApplication.translate("TrailblazePowerWidget", u"\u865a\u5e7b\u94f8\u94c1\uff08\u91cf\u5b50\uff09", None))
        self.stagnantShadow_comboBox.setItemText(23, QCoreApplication.translate("TrailblazePowerWidget", u"\u7eb7\u4e89\u524d\u5146\uff08\u865a\u6570\uff09", None))
        self.stagnantShadow_comboBox.setItemText(24, QCoreApplication.translate("TrailblazePowerWidget", u"\u4e00\u66f2\u548c\u5f26\u7684\u5e7b\u666f\uff08\u865a\u6570\uff09", None))
        self.stagnantShadow_comboBox.setItemText(25, QCoreApplication.translate("TrailblazePowerWidget", u"\u9547\u7075\u6555\u7b26\uff08\u865a\u6570\uff09", None))
        self.stagnantShadow_comboBox.setItemText(26, QCoreApplication.translate("TrailblazePowerWidget", u"\u5f80\u65e5\u4e4b\u5f71\u7684\u91d1\u9970\uff08\u865a\u6570\uff09", None))
        ...
        self.caverOfCorrosion_comboBox.setItemText(1, QCoreApplication.translate("TrailblazePowerWidget", u"\u9690\u6551\u4e4b\u5f84\uff08\u6551\u4e16\u4e3b/\u9690\u58eb\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(2, QCoreApplication.translate("TrailblazePowerWidget", u"\u96f3\u52c7\u4e4b\u5f84\uff08\u5973\u6b66\u795e/\u8239\u957f\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(3, QCoreApplication.translate("TrailblazePowerWidget", u"\u5f26\u6b4c\u4e4b\u5f84\uff08\u82f1\u8c6a/\u8bd7\u4eba\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(4, QCoreApplication.translate("TrailblazePowerWidget", u"\u8ff7\u8bc6\u4e4b\u5f84\uff08\u53f8\u94ce\u5957/\u5b66\u8005\u5957\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(5, QCoreApplication.translate("TrailblazePowerWidget", u"\u52c7\u9a91\u4e4b\u5f84\uff08\u94c1\u9a91\u5957/\u52c7\u70c8\u5957\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(6, QCoreApplication.translate("TrailblazePowerWidget", u"\u68a6\u6f5c\u4e4b\u5f84\uff08\u6b7b\u6c34/\u949f\u8868\u5320\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(7, QCoreApplication.translate("TrailblazePowerWidget", u"\u5e7d\u51a5\u4e4b\u5f84\uff08\u5927\u516c/\u5e7d\u56da\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(8, QCoreApplication.translate("TrailblazePowerWidget", u"\u836f\u4f7f\u4e4b\u5f84\uff08\u83b3\u8005/\u4fe1\u4f7f\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(9, QCoreApplication.translate("TrailblazePowerWidget", u"\u91ce\u7130\u4e4b\u5f84\uff08\u706b\u5320/\u5e9f\u571f\u5ba2\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(10, QCoreApplication.translate("TrailblazePowerWidget", u"\u5723\u9882\u4e4b\u5f84\uff08\u5723\u9a91/\u4e50\u961f\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(11, QCoreApplication.translate("TrailblazePowerWidget", u"\u777f\u667a\u4e4b\u5f84\uff08\u94c1\u536b/\u91cf\u5b50\u5957\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(12, QCoreApplication.translate("TrailblazePowerWidget", u"\u6f02\u6cca\u4e4b\u5f84\uff08\u8fc7\u5ba2/\u5feb\u67aa\u624b\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(13, QCoreApplication.translate("TrailblazePowerWidget", u"\u8fc5\u62f3\u4e4b\u5f84\uff08\u62f3\u7687/\u602a\u76d7\uff09", None))
        self.caverOfCorrosion_comboBox.setItemText(14, QCoreApplication.translate("TrailblazePowerWidget", u"\u971c\u98ce\u4e4b\u5f84\uff08\u51b0/\u98ce\u5957\uff09", None))
