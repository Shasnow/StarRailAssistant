...
class DUIMG:
    ...
    DIFFERENTIAL_UNIVERSE_START = f"{BASE}/divergent_universe_start.png"
    DIFFERENTIAL_UNIVERSE_QUIT = f"{BASE}/divergent_universe_quit.png"
    DIFFERENTIAL_UNIVERSE = f"{BASE}/divergent_universe.png"
    ...
    LAUNCH_DIFFERENTIAL_UNIVERSE = f"{BASE}/launch_divergent_universe.png"
