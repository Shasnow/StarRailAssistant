...
class ToggleSwitch(QWidget):
    ...
    def getKnobX(self):  # NOQA
        """获取滑块 X 坐标"""
        return self._knob_x

    def setKnobX(self, value):  # NOQA
        """设置滑块 X 坐标并触发更新"""
        self._knob_x = value
        self.update()

    knob_x = Property(int, fget=getKnobX, fset=setKnobX)  # NOQA 定义可动画化的属性
