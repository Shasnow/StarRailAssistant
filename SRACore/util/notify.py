...
def send_mail_notification(title: str | dict = "SRA", message: str | NotificationSettings | None = "",
...
def send_webhook_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
    from SRACore.util.logger import logger
    config = configure or _load_notification_settings()
...
def send_telegram_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
...
def send_serverchan_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
    import re
    from SRACore.util.logger import logger
    config = configure or _load_notification_settings()
...
def send_onebot_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
...
def send_bark_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
...
def send_feishu_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
...
def send_wecom_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
...
def send_dingtalk_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
...
def send_discord_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
...
def send_xxtui_notification(data: dict, configure: NotificationSettings | None = None) -> bool:
