...
下载链接：  
下载更新器，借助更新器下载：[SRA更新器](https://github.com/Shasnow/StarRailAssistant/releases/download/v0.6.5/SRAUpdater.exe)  
或者直接下载本体，里面包含了更新器：[SRAv0.6.6](https://github.com/Shasnow/StarRailAssistant/releases/download/v0.6.6/StarRailAssistant_v0.6.6.zip)
