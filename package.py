...
if __name__ == "__main__":
    ...
    shutil.copytree(root_path / "SRACore/tasks", root_path / "main.dist/SRACore/tasks")
    shutil.copytree(root_path / "SRACore/component", root_path / "main.dist/SRACore/component")
    shutil.copytree(root_path / "SRACore/ui", root_path / "main.dist/SRACore/ui")
    ...
    os.remove(root_path / "main.dist/SRACore/component/dialog.py")
    os.remove(root_path / "main.dist/SRACore/component/main_window.py")
    os.remove(root_path / "main.dist/SRACore/component/multi_account.py")
    os.remove(root_path / "main.dist/SRACore/component/settings_page.py")
    os.remove(root_path / "main.dist/SRACore/component/mission_accomplish.py")
    os.remove(root_path / "main.dist/SRACore/component/shutdown_dialog.py")
    os.remove(root_path / "main.dist/SRACore/component/tray.py")
    os.remove(root_path / "main.dist/SRACore/ui/main_ui.py")
    os.remove(root_path / "main.dist/SRACore/ui/shutdown_dialog_ui.py")
